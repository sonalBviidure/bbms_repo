...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["signup"])) {
        ...
        // Handle file uploads
        $t_upload_id_prof = handleFileUpload("f_idproof", "uploads/idproof/");
        $t_employe_resume = handleFileUpload("f_resume", "uploads/resume/");
        $t_profile_photo = handleFileUpload("f_profilePhoto", "uploads/profile_photos/");
...
<body>
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <!-- Signup Form -->
                <form id="signupForm" action="employe.php" method="post" enctype="multipart/form-data">
    ...
    <script>
        function toggleForms() {
            ...
            signupForm.reset(); // Reset form fields on toggle
