...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="dropdown">
            <a href="job_provider_fetch.php" class="dropdown-toggle">
        ...
        <div class="dropdown">
            <a href="stud_fetch.php" class="dropdown-toggle">
        ...
        <div class="dropdown">
        <a href="#" class="dropdown-toggle">
            <i class="fas fa-book"></i> Internship
        </a>
            <div class="dropdown-menu">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu">
                ...
                <a href="event_fetch.php">View Event</a>
            </div>
        </div>

        <div class="dropdown">
            <a href="coursenq_fetch.php" class="dropdown-toggle">
        ...
        <div class="dropdown">
            <a href="hm_enq_fetch.php" class="dropdown-toggle">
        ...
        <div class="dropdown">
            <a href="placement.php" class="dropdown-toggle">
