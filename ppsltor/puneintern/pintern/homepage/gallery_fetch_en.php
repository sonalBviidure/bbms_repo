...
<head>
    ...
    th, td {
        padding: 8px 0px; /* Reduce padding for table cells */
        text-align: center;
...
<body>  
    ...
    <h1>Gallery Status</h1>
    <br>
    <form method="post" action="gallery_status_en.php">
        ...
        <table>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    //echo "<td><img src='" . htmlspecialchars($row["t_gallery_img"]) . "' alt='Event Image' style='max-width: 100px; max-height: 100px;'></td>"; 
                    // Display image
