            ...
            document.addEventListener(\'DOMContentLoaded\', function () {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = "Spoken English.php";
                    }
                });
            });
        </script>';
        ...
        <div class="course-cards-container">
           <?php
            ...
            if ($result->num_rows > 0) {
                ...
                echo '</strong></div>';
                echo '<div class="description"><strong>This course is designed to help students improve their spoken English skills, focusing on fluency, pronunciation, vocabulary, and confidence in various speaking situations. Through interactive activities, discussions, and practical exercises, students will develop the ability to communicate effectively and confidently in English.</strong></div>';
