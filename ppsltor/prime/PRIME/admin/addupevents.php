...
if(isset($_POST['submit'])) {
    ...
    if ($con->connect_error) {
     ...
     $sql = "INSERT INTO upevents (upevent_title, upevent_date, upevent_location, upevent_meet) VALUES ('$eventTitle', '$eventDate', '$eventLocation','$eventmeet')";
     ...
     if ($con->query($sql) === TRUE) {
         ...
         for($i = 0; $i < count($_FILES['eventImages']['name']); $i++) {
             ...
             $imageColumn = "upevent_image" . ($i + 1);
             $updateImageSql = "UPDATE upevents SET $imageColumn = '$targetFile' WHERE upevent_id = '$lastInsertedId'";
             $con->query($updateImageSql);
         }
 
         echo '<script>alert("Event and images inserted successfully.");</script>';
         header('location: ./addupevents.php');
     }
      else {
        ...
        <div id="content" style="background-color:white;">
            ...
            <div class="main-content">
                <div class="container card shadow p-3 bg-white rounded">
                            ...
                            <a href="viewupevents.php" class="btn btn-primary">View Events</a>
                        </div>
                        <h2 class="text-center">Add Upcoming Events</h2>
