...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO registration VALUES ('','$firstName', '$middleName', '$lastName', '$contactNumber', '$email', '$password', '$state', '$district', '$subdistrict', '$village', '$pincode', '$status')";
...
<body>
    ...
    <a href="login.php" class="back-arrow text-center"><i class="fas fa-arrow-left"></i></a>
    ...
    <div class="form-row row mt-5 mb-3">
           ...
           <!--   <a type="submit" name="submit" href="login.php" target="_blank" class="btn btn-primary">Register</a> -->
              <button type="submit" class="btn btn-primary" name="submit" href="student/index.php">Register</button> 
