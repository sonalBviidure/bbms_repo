...
<nav id="sidebar">
    <div class="sidebar-header">
        <h3><img src="image/logo.jpeg" class="img-fluid" style="width: 30px;" /><span>BBMS</span></h3>
    </div>
    <ul class="list-unstyled components" style="margin-top:70px">
        ...
        <li class="dropdown">
            <a href="#homeSubmenu1" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                <i class="material-icons">business</i>Matrix
            </a>
            <ul class="collapse list-unstyled menu" id="homeSubmenu1">
                <li><a href="add_matrix.php">Add Matrix</a></li>
                <li><a href="view_matrix.php">View Matrix</a></li>
      ...
      <!--  <li class="dropdown">
            <a href="#homeSubmenu3" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                <i class="material-icons">group</i>Board Members
            </a>
        ...
        <li class="dropdown">
            ...
            <ul class="collapse list-unstyled menu" id="homeSubmenu6">
                <li><a href="addjobvacancy.php">Add Job Vacancy</a></li>
                <li><a href="viewjobvacancy.php">View Job Vacancy</a></li>
                <li><a href="viewapplication.php">View Application</a></li>
            </ul>
        </li>-->
        <li class="dropdown">
            <a href="viewinquiry.php" aria-expanded="false">
                <i class="material-icons">mail</i> Matrix Inquiry
            </a>
        </li>

        <li class="dropdown">
            <a href="view_meeting.php" aria-expanded="false">
                <i class="material-icons">event_note</i>Meetings
            </a>
        </li>
        <li class="dropdown">
