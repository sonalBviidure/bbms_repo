                                    ...
                                    if ($result->num_rows > 0) {
                                        while($row = $result->fetch_assoc()) {
                                            ...
                                            if(!empty($row['meeting_image'])) {
                                                echo "<img src='../Franchise/uploads/meetings/" . $row['meeting_image'] . "' class='img-thumbnail' width='100' height='100' alt='Meeting Image'>";
                                            } else {
                                                echo "<img src='../image/no-image.png' class='img-thumbnail' width='100' height='100' alt='No Image'>";
                                            }
                                            echo "</td>";
