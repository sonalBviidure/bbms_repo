                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card card-stats">
                            ...
                            <div class="card-content">
                                <p class="category"><strong>References</strong></p>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card card-stats">
                            ...
                            <div class="card-content">
                                <p class="category"><strong>Meeting Venue</strong></p>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card card-stats">
                            ...
                            <div class="card-content">
                                <p class="category"><strong>Matrixs</strong></p>
