            ...
            document.addEventListener(\'DOMContentLoaded\', function () {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = "LR Brain.php";
                    }
                });
            });
        </script>';
    ...
    <section class="courses">
        ...
        <div class="course-cards-container">
            ...
            if ($result->num_rows > 0) {
                ...
                echo '</strong></div>';
                echo '<div class="description"><strong>Course Description goes here. Provide a brief overview of the course.Course Description goes here. Provide a brief overview of the course.</strong></div>';
              ...
              //  echo '<a href="#" class="inquiry-btn btn btn-primary" data-bs-toggle="modal" data-bs-target="#inquiryModal">Inquire Now</a>&nbsp&nbsp<a href="admin/syllabus/' . $row["t_syllabus"] . '" //target="_blank" class="inquiry-btn btn btn-primary">View Syllabus</a>';
                //echo '</div>';
                //echo '</div>';
            } else {
                echo "0 results";
