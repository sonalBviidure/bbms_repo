            ...
            document.addEventListener(\'DOMContentLoaded\', function () {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = "Confidence Building.php";
                    }
                });
            });
        </script>';
...
<?php include('navbar.php');?> 
    <section class="courses">
        ...
        <div class="course-cards-container">
            ...
            $coursename = "Confidence Building";
            ...
            if ($result->num_rows > 0) {
                ...
                echo '</strong></div>';
                echo '<div class="description"><strong>The Confidence Building and Self-Empowerment course aim to equip participants with the necessary tools and techniques to enhance their self-confidence, self-esteem, and assertiveness. Through a combination of theoretical knowledge, practical exercises, and personal development strategies, participants will develop a deeper understanding of themselves and build the confidence to pursue their goals and aspirations.</strong></div>';
