            ...
            document.addEventListener(\'DOMContentLoaded\', function () {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = "Public Speaking.php";
                    }
                });
            });
        </script>';
    ...
    <section class="courses">
        ...
        <div class="course-cards-container">
            ...
            if ($result->num_rows > 0) {
                ...
                echo '</strong></div>';
                echo '<div class="description"><strong>The Mastering Public Speaking course is designed to help participants develop the skills and confidence needed to deliver compelling presentations and speeches in various settings. Through a combination of theory, practice, and feedback, participants will learn effective techniques for structuring speeches, engaging audiences, managing nerves, and enhancing overall speaking effectiveness</strong></div>';
